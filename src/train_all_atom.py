...
from src.model.integral import atom_training_predict
from src.model.protein_transformer import AtomTransformer
...
@hydra.main(version_base="1.3", config_path="../configs", config_name="train_all_atom")
